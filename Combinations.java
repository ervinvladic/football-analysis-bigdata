...
public class Combinations {
    ...
    public static class CombinationMapper extends Mapper<Object, Text, Text, IntWritable> {
    ...
    public static class CombinationReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "result combinations count");
        job.setJarByClass(Combinations.class);
